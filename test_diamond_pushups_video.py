...
# Test the diamond pushup analysis endpoint with your diamond.mp4 video
url = "http://192.168.0.105:8001/diamond_pushups"

# Path to your diamond pushup video
video_path = "/Users/utkarshsundkar/Desktop/error/MyApp/videos/diamond.mp4"

# Open and send the video file
with open(video_path, 'rb') as video_file:
    files = {'file': ('diamond.mp4', video_file, 'video/mp4')}
    data = {'flip': '1'}  # Flip the video if needed
    
    print("Sending diamond pushup video for analysis...")
