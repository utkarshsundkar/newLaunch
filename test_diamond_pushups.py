...
# Test the diamond pushup analysis endpoint
url = "http://192.168.0.105:8001/diamond_pushups"

# Use the same pushups1.mp4 file for testing (you'll need to record actual diamond pushups for better results)
...
with open(video_path, 'rb') as video_file:
    ...
    print("Sending video for diamond pushup analysis...")
